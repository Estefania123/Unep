...
namespace ProgramacionAmbientes.Controllers
{
    public class FichaController : ApiController
    {
        ...
        public IHttpActionResult ConsultarFichas()
        {
            try
            {
                ...
                foreach (var item in Datos)
                {
                    ...
                    oParametrosDTO.Parametro2 = item.NumFicha.ToString();
                    ...
                    oParametrosDTO.Parametro10 = item.FechaLimite.ToString();
                    oParametrosDTO.Parametro11 = item.FechaMomentoDos.ToString();
                    oParametrosDTO.Parametro12 = item.FechaMomentoTres.ToString();
        ...
        [HttpPost]
        public IHttpActionResult EliminarFicha(ParametrosDTO oParametrosDTO)
        {
            try
            {
                FichaBl oFichaBl = new FichaBl();
                ...
                {
                    oFichaBl.EliminarFicha(int.Parse(item.Parametro1));
                }
